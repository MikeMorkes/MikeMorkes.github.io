...
get_header(); ?>
	...
	<div class="container_12">	
		<div class="content">
			  ...
			  <div id="thumbnail"><?php the_post_thumbnail( array (140,140) );?></div>
  			  ...
  			  <h2><img src="http://www.mikemorkes.com/transcity/wp-content/uploads/2012/08/ohno.jpg" alt="Oh Noooooooooooooooooo!"></h2>  
  			    
  			  <p>Sorry y'all, I didn't find nothing! That's okay, right?</p>  
		...
		<div class="sidebar">
					...
					<div class="grid_2 one-portfolio">
						<a href=""><img src="<?php bloginfo('template_url'); ?>/img/limoworld_thumb.jpg" width="140" height="140" border="0" /></a><br />
						<p>website</p>
					</div>
